...
class Table:
    ...
    def draw (self,window):
        ...
        pygame.draw.circle(window, self.color, [740, 59], self.size)
        pygame.draw.circle(window, self.color, [60, 521], self.size)
        pygame.draw.circle(window, self.color, [740, 523], self.size)
